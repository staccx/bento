...
Then we need to import our theme into our app and make it accessible to all the components. This is done by using styled-components' theme-provider. We should also import WebFonts and GlobalStyle from bento so that we get these global styles in our app.
...
import { WebFonts, GlobalStyle, Button, CheckBox } from "@staccx/bento"
...
export const inputVariants = theming.createVariants(
  {
