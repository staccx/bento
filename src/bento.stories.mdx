...
There should exist plenty of examples here to allow you to write these. This being of of them. Remember that you can use [MDX](https://github.com/mdx-js/mdx) now.
...
Stories can also be written in [MDX](https://github.com/mdx-js/mdx) now.
