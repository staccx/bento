 ...
 */
export function applyVariants(themeProps: any) {
  return (props: any) => {
    ...
    const name = themeProps.hasOwnProperty("name")
      ? themeProps.name
      : themeProps
 ...
 */
function getVariants(theme: any, variant: any, name: string) {
 ...
 * @returns {object}
 */
function getVariant(theme: any, variant: any, name: string) {
