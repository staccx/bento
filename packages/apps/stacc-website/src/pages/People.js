...
import { Flag, Heading, Wrapper } from "@staccx/base"
      ...
      {people.map(person => (
        <PersonItem key={person.firstName + person.lastName}>
          ...
          >
            ...
            <Title>
              {person.title}, Stacc {person.company}
            </Title>
            <SubtleLink href={`mailto:${person.email}`}>
              {person.email}
            </SubtleLink>{" "}
            <br />
            ...
            <br />
            {person.linkedin && (
              <SubtleLink href={person.linkedin}>
                <svg
            ...
            {person.twitter && (
              <SubtleLink href={person.twitter}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
