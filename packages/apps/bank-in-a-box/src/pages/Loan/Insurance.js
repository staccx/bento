        ...
        <LayoutItem variant="fadeIn" delay="400">
          <Layout>
            ...
            <List>
              ...
              <li>
                Arbeidsledighet/permittering som inntreffer i Norge Dødsfall
                (for arbeidstakere og selvstendig næringsdrivende)
              </li>
            </List>
            ...
            <List>
              <li>
                ...
                over 30 dager kan forsikringen dekke 1/30 av månedlig
                terminbeløp for hver dag.
              </li>
              <li>
              ...
              <li>
                Ved dødsfall kan resterende gjeld på lånet bli slettet,
                maksimalt 500 000,-.
              </li>
            </List>
          </Layout>
