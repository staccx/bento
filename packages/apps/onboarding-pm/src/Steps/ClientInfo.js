    ...
    const items = [
      ...
      <Layout rowGap="small">
        ...
        <CheckGroup onChange={handleOriginChange} group="origin">
          ...
          <CheckBox group="opprinnelse" id="other" value="other" key="test383">
            Annet
          </CheckBox>
        </CheckGroup>
      </Layout>,
      <Layout rowGap="small">
        ...
        <CheckGroup onChange={handleUtenlandsChange} group="utenlands">
          ...
          <CheckBox id="5436457" value="notOnlyPrivatePurpose" key="ewrrtgfhg">
      ...
      <Layout rowGap="small">
        ...
        <CheckGroup onChange={handleSamtykkeChange} group="samtykke">
          ...
          <CheckBox
            ...
            key="45fdfed"
          >
            Jeg samtykker til mottak av av tilbud og nyheter om andre produkter.
          </CheckBox>
        </CheckGroup>
      </Layout>,
      ...
      <Wrapper size="small">
        <Layout rowGap="large" paddingTop="huge" paddingBottom="large">
          <Trail
            ...
            to={{ opacity: 1, x: 0 }}
            keys={items.map((item, index) => "Trail" + index)}
          >
