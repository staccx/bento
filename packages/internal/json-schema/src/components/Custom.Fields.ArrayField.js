import { AddButton } from "./Custom.Fields.Array"
...
const ArrayFieldTitle = ({ TitleField, idSchema, title, required }) => {
  ...
  return <TitleField id={id} wtf title={title} required={required} />
}
...
class ArrayField extends Component {
  ...
  constructor(...args) {
    ...
    if (schema.minItems && !formData.length) {
      this.onAddClick(new Event("AddMissing"))
    }
  }
