...
export const IconLoggedOutConfirmation = theming.createVariants(
  { [theming.VARIANT_DEFAULT]: LoggedOutConfirmation },
  "IconLoggedOutConfirmation"
)

export default IconLoggedOutConfirmation
